...
?>
                            ...
                            <div class="col-md-8">
                                <div class="entity_wrapper">
                                    <div class="entity_title">
                                        <h1><a href="single.php" target="_self">Airbnb launches photo-centric app for iPads and Android tablets.</a>
                                        </h1>
                                    </div>
                                    <!-- entity_title -->
            ...
            <span class="share_ic">Shares</span>
                                    ...
                                    <div class="entity_content">
                                        <p>But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer
                                ...
                                <div class="entity_wrapper">
                                    <div class="entity_title">
                                        <h1><a href="single" target="_self">Airbnb launches photo-centric app for iPads and Android tablets.</a>
                                        </h1>
                                    </div>
                                    <!-- entity_title -->
            ...
            <span class="share_ic">Shares</span>
                                            ...
                                            <div id="featured-news-carousal" class="carousel slide" data-ride="carousel">
                                                ...
                                                <div class="carousel-inner" role="listbox">
                                                    <div class="item active">
                                                        <img class="img-responsive" src="/template/public/img/category_img9.jpg" alt="Chania">
                                                    </div>
                                                    <!--feature_news_item-->
                                                    <div class="item">
                                                        <img class="img-responsive" src="/template/public/img/category_img13.jpg" alt="Chania">
                                                    </div>
                                                    <!--feature_news_item-->
                                                    <div class="item">
                                                        <img class="img-responsive" src="/template/public/img/category_img14.jpg" alt="Chania">
                                                    </div>
                                                    <!--feature_news_item-->
                                                    <div class="item">
                                                        <img class="img-responsive" src="/template/public/img/category_img15.jpg" alt="Chania">
                                                    </div>
                                                    <!--feature_news_item-->
                            ...
                            <i class="fa fa-chevron-left" aria-hidden="true"></i> </a>
                                                        <a class="right carousel-control" href="#featured-news-carousal" role="button" data-slide="next"> <i class="fa fa-chevron-right" aria-hidden="true"></i> </a>
                                                    </div>
                                        ...
                                        <div class="col-md-5">
                                            <div class="right_category_image">
                                                <img class="img-responsive" src="/template/public/img/category_img10.jpg" alt="feature-top">
                                            </div>
                                            <!--carousel-->

                                            <div class="right_category_image">
                                                <img class="img-responsive" src="/template/public/img/category_img11.jpg" alt="feature-top">
                                            </div>
                                            <!--carousel-->
            ...
            <span class="share_ic">Shares</span>
                                    ...
                                    <div class="entity_thumb">
                                        <img class="img-responsive" src="/template/public/img/category_img12.jpg" alt="feature-top">
                                    </div>
                                    <!-- entity_thumb -->
            ...
            <span class="share_ic">Shares</span>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h3 class="media-heading">
                                                <a href="single" target="_self">Canon launches photo centric 00214 Model supper shutter camera</a>
                    ...
                    <a href="single" target="_self"><i class="fa fa-comments-o"></i>4</a> Comments
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h3 class="media-heading">
                                                <a href="single" target="_self">Samsung galaxy note are the supper mobile of all products.</a>
                                            </h3>
                    ...
                    <a href="single" target="_self"><i class="fa fa-comments-o"></i>4</a> Comments
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h3 class="media-heading">
                                                <a href="single" target="_self">Apple launches photo-centric wrist watch for Android</a>
                                            </h3>
                                            <span class="media-date"><a href="#">10Aug- 2015</a>,  by: <a href="#">Eric joan</a></span>
                    ...
                    <a href="single" target="_self"><i class="fa fa-comments-o"></i>4</a> Comments
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h3 class="media-heading">
                                                <a href="single" target="_self">Kodak Hi-Speed shutter double shot camera comming soon</a>
                                            </h3>
                                            <span class="media-date"><a href="#">10Aug- 2015</a>,  by: <a href="#">Eric joan</a></span>
                    ...
                    <a href="single" target="_self"><i class="fa fa-comments-o"></i>4</a> Comments
                                ...
                                <div class="widget reviews m30">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h3 class="media-heading">
                                                <a href="single" target="_self">DSLR is the most old camera at this time readmore about new
                    products</a>
                                            </h3>
                                            <span class="rating">
                <i class="fa fa-star"></i>
                ...
                <i class="fa fa-star-half-full"></i>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h3 class="media-heading"><a href="single" target="_self">Samsung is the best
            mobile in the android market.</a></h3> <span class="rating">
                ...
                <i class="fa fa-star-half-full"></i>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h3 class="media-heading">
                                                <a href="single" target="_self">Yasaki camera launches new generic hi-speed shutter camera.</a>
                                            </h3>
                                            <span class="rating">
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
                ...
                <i class="fa fa-star-half-full"></i>
                                ...
                                <div class="widget m30">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h3 class="media-heading">
                                                <a href="single" target="_self">Samsung is the best mobile in the android market.</a>
                                            </h3>
